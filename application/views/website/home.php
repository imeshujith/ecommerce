                    ...
                    <div class="categories__slider owl-carousel">
                        <div class="col-lg-3">
                            <div
                                ...
                                data-setbg="<?php echo base_url(); ?>assets/img/categories/cat-1.jpg"
                            >
                ...
                <div class="row featured__filter">
                    ...
                    >
                        <div class="featured__item">
                            <div
                                ...
                                data-setbg="<?php echo base_url(); ?>assets/img/featured/feature-1.jpg"
                            >
                    ...
                    >
                        <div class="featured__item">
                            <div
                                class="featured__item__pic set-bg"
                                data-setbg="<?php echo base_url(); ?>assets/img/featured/feature-2.jpg"
                            >
                                <ul class="featured__item__pic__hover">
                                    <li>
                                        <a href="#"
                    ...
                    >
                        <div class="featured__item">
                            <div
                                class="featured__item__pic set-bg"
                                data-setbg="<?php echo base_url(); ?>assets/img/featured/feature-3.jpg"
                            >
                                <ul class="featured__item__pic__hover">
                                    <li>
                                        <a href="#"
                    ...
                    >
                        <div class="featured__item">
                            <div
                                class="featured__item__pic set-bg"
                                data-setbg="<?php echo base_url(); ?>assets/img/featured/feature-4.jpg"
                            >
                                <ul class="featured__item__pic__hover">
                                    <li>
                                        <a href="#"
                    ...
                    >
                        <div class="featured__item">
                            <div
                                class="featured__item__pic set-bg"
                                data-setbg="<?php echo base_url(); ?>assets/img/featured/feature-5.jpg"
                            >
                                <ul class="featured__item__pic__hover">
                                    <li>
                                        <a href="#"
                    ...
                    >
                        <div class="featured__item">
                            <div
                                class="featured__item__pic set-bg"
                                data-setbg="<?php echo base_url(); ?>assets/img/featured/feature-6.jpg"
                            >
                                <ul class="featured__item__pic__hover">
                                    <li>
                                        <a href="#"
                    ...
                    >
                        <div class="featured__item">
                            <div
                                class="featured__item__pic set-bg"
                                data-setbg="<?php echo base_url(); ?>assets/img/featured/feature-7.jpg"
                            >
                                <ul class="featured__item__pic__hover">
                                    <li>
                                        <a href="#"
                    ...
                    >
                        <div class="featured__item">
                            <div
                                class="featured__item__pic set-bg"
                                data-setbg="<?php echo base_url(); ?>assets/img/featured/feature-8.jpg"
                            >
                                <ul class="featured__item__pic__hover">
                                    <li>
                                        <a href="#"
